...
namespace Proxies\__CG__\Easy\UtilisateurBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Utilisateur extends \Easy\UtilisateurBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setSteam($steam);
    }

    public function getSteam()
    {
        $this->__load();
        return parent::getSteam();
    }

    public function setLeitmotiv($leitmotiv)
    {
        $this->__load();
        return parent::setLeitmotiv($leitmotiv);
    }
