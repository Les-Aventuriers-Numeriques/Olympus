...
--
-- Serveur: localhost
-- Généré le : Sam 12 Octobre 2013 à 07:38
...
INSERT INTO `categorieforum` (`id`, `libelle`, `description`, `ordre`) VALUES
(1, 'Général', 'Catégorie Générale', '1'),
(2, 'Jeux', 'Discussions sur les jeux', '2'),
(3, 'Partie Privée', 'Réservée à la =EaSy= Company', '3');
...
CREATE TABLE IF NOT EXISTS `forum` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_852BBECD114BFBBA` (`categorie_forum_id`)
...
INSERT INTO `forum` (`id`, `libelle`, `description`, `ordre`, `categorie_forum_id`) VALUES
(1, 'Règlements', NULL, 1, 1),
(2, 'Bar à bières', NULL, 2, 1),
(3, 'Aide', NULL, 3, 1),
(4, 'ArmA III', NULL, 1, 2),
(5, 'Battlefield 4', NULL, 2, 2),
(6, 'Minecraft', NULL, 3, 2),
(7, 'Autres Jeux', NULL, 4, 2),
(8, 'Vie de la communauté', NULL, 1, 3),
(9, 'Préparation des évènements', NULL, 2, 3),
(10, 'Gestion de l''effectif', NULL, 3, 3);
...
CREATE TABLE IF NOT EXISTS `sujet` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_2E13599D29CCBAD0` (`forum_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
INSERT INTO `sujet` (`id`, `titre`, `date`, `forum_id`) VALUES
(1, 'Règlement TS', '2013-10-05 22:03:59', 1),
(2, 'Vos bureaux', '2013-10-05 22:04:25', 2);
...
(4, 'a', 'b', 'email', 'Ys8cnl4TmA796VID5HRnx+IJsjtw3sFho5GKAzce75FBHyV903ClBqSTLnymc/DXG7xXL5yL2vHv3rMtGypVEw==', '', 'username', 'username', 'email', 1, '7kj7zuhjgfc4so44gk0ksc0k8soogs8', '2013-10-12 09:12:08', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, '', '', 0);
...
ALTER TABLE `chatmessage`
  ADD CONSTRAINT `FK_61735696F675F31B` FOREIGN KEY (`author_id`) REFERENCES `utilisateur` (`id`);
...
--
ALTER TABLE `forum`
  ADD CONSTRAINT `FK_852BBECD114BFBBA` FOREIGN KEY (`categorie_forum_id`) REFERENCES `categorieforum` (`id`);
...
--
ALTER TABLE `sujet`
  ADD CONSTRAINT `FK_2E13599D29CCBAD0` FOREIGN KEY (`forum_id`) REFERENCES `forum` (`id`);
