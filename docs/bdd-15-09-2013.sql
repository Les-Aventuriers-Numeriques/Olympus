...
--
-- Serveur: localhost
-- Généré le : Dim 15 Septembre 2013 à 08:12
...
(4, 'C''est Vendredi !', 'C''est Vendredi !');
...
(1, 'LAUNES', 'Guillaume', 'guitouzid@wanadoo.fr', 'EP4zy7ZEBsdfU+EjwjkwHlTc/CAG4V5yfl0aBAgPYW0Ne2+J3RebFfT/vRNbdqmHrzmymejw6I2RG4gklGZNEw==', 'fdfssqddsdsqd', 'guitouzid', 'guitouzid', 'guitouzid@wanadoo.fr', 1, '2vp978oj2cysgogoc4csc8oo8koogsc', '2013-09-15 10:00:10', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, 'guitouzid', 'dsd44654', 0),
(3, NULL, NULL, 'test@test.fr', 'NP49WTs0piKutse+1fMqKiZfVwU9W8aIK9nvxFkrzqBJ6Y3sXucOCy6zj62nUjdqfZs8pkHmkG7sGm6N0B/hQg==', NULL, 'test', 'test', 'test@test.fr', 1, 'qiivp2tmamocs8wco0sws4wsw8ggwoc', NULL, 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, NULL, NULL, NULL);
